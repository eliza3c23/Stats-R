...
#
  x= examdata$Midterm
  y= examdata$Final
  plot(x,y, main = "ST314 students Midterm score vs Final score",pch=20,col="darkblue", xlab = "Midterm score",ylab = "Final score")
...
# R create a residual plot:
  ...
  plot(x,mod$residuals,main = "Residual Plot",xlab = "Midterm score",ylab = "Residuals",pch=16,col="orange")
  abline(h= 0, lty = 2) 
